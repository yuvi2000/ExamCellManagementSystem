	  ...
	  public int update(NominalRole p){  
		...
		public void register1(Papers subject){
		  ...
		  public Papers showSubjects(Papers subject) {
		    ...
		    String sql = "select num_trn_paper_id, num_degree_id, num_dept_id, num_year_id, num_sem_id, num_paper_id from tbl_trn_papers";
		  ...
		  public int update1(Papers p){  
			...
			public Papers getPapersById(int semester){  
			    String sql="select num_trn_paper_id, num_degree_id, num_dept_id, num_year_id, num_sem_id, num_paper_id from tbl_trn_papers where num_trn_paper_id=?";  
			...
			public List<Papers> getAllPapers(){  
			    return jdbcTemplate.query("select num_trn_paper_id, num_degree_id, num_dept_id, num_year_id, num_sem_id, num_paper_id  from tbl_trn_papers",new RowMapper<Papers>(){  
